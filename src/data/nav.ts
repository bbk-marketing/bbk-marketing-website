...
/**
 * Phase A (homepage-only launch): items below point to homepage anchor sections.
 * Phase B will give each item a dedicated route (e.g. /clinical-research-marketing) —
